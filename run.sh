...
if ! [[ ( -z $1 ) && ( -z $2 ) ]]; then
	...
	python3 ./organize_components/convert_and_organize_ad.py $1 $2
	echo Running convert_and_organize_epics.py
	python3 ./organize_components/convert_and_organize_epics.py $1 $2
	echo Running update_references.py
	python3 ./organize_components/update_references.py $1 $2
elif ! [ -z $1 ]; then
	echo Running convert_and_organize_ad.py
